package com.proxym.yacine.codintest.config.security;
...
public class TokenProvider implements Serializable {
    ...
    public String generateToken(Authentication authentication) {
        ...
        AppUser authUser = appUserService.findByEmail(authentication.getName());
        if (authUser.isVerified() && authUser.getState().equals(UserState.ACTIVE)) {
            return Jwts.builder()
            ...
            throw new CustomException("Your account should be verified", "ACCOUNT NOT VERIFIED", 400);
        }
